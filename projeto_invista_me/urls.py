...
urlpatterns = [
    ...
    path('', views.so_investimento,name='investimentos'),
    ...
    path('novo_investimento/',views.criar,
         name='novo'),
    path ('novo_investimento/<int:id_investimento>', views.editar , name= 'editar'),   # type: ignore  # noqa: E501
    path ('exc_investimento/<int:id_investimento>', views.excluir , name= 'excluir'),  
